...
public class CheckerTestUtilTest extends KotlinTestWithEnvironment {
    ...
    public void testEquals() throws Exception {
        doTest(new TheTest() {
            @Override
            protected void makeTestData(List<CheckerTestUtil.ActualDiagnostic> diagnostics, List<DiagnosedRange> diagnosedRanges) {
            }
        });
    }
    ...
    private static abstract class TheTest {
        ...
        public void test(@NotNull PsiFile psiFile, @NotNull KotlinCoreEnvironment environment) {
            ...
            List<CheckerTestUtil.ActualDiagnostic> actualDiagnostics =
                    CheckerTestUtil.getDiagnosticsIncludingSyntaxErrors(bindingContext, psiFile, false, null);
        ...
        protected abstract void makeTestData(List<CheckerTestUtil.ActualDiagnostic> diagnostics, List<DiagnosedRange> diagnosedRanges);
    }
